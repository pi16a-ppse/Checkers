 ...
 * @method executeMove
 * @param {} X - положение шашки игрока по оси абсцисс
 * @param {} Y - положение шашки игрока по оси ординат
 * @param {} nSquare - движение по квадрату
 * @return null
 */
...
/**
 * Проверка на наличие ходов для игрока
 * @method checkForMoves
 * @return bool
 */
